...
def app():
	...
	st.subheader("Two Functions can be Performed: Tweet Analyzer, Generate Twitter Data")
	...
	if choice=="Tweet Analyzer":
		...
		st.subheader("Tweet Analyzer: Analyze the tweets of your favourite Personalities")
		...
		raw_text = st.text_area("Enter the exact twitter handle of the Personality ")
	...
	st.subheader(' ------------------------Created By :  ISHAAN TAKKAR ----------------------  ')
	st.subheader(' ----------------Under Guidance of :  Dr. Parshant Singh Rana -------------  ')
